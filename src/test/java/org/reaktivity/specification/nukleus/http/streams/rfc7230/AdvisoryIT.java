...
public class AdvisoryIT
{
    private final K3poRule k3po = new K3poRule()
        .addScriptRoot("scripts", "org/reaktivity/specification/nukleus/http/streams/rfc7230/advisory");
    ...
    @Test
    @Specification({
        "${scripts}/request.and.flush/client",
        "${scripts}/request.and.flush/server"})
