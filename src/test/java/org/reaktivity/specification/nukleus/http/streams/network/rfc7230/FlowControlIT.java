 ...
 * under the License.
 */
package org.reaktivity.specification.nukleus.http.streams.network.rfc7230;
...
public class FlowControlIT
{
    private final K3poRule k3po = new K3poRule()
        .addScriptRoot("net", "org/reaktivity/specification/nukleus/http/streams/network/rfc7230/flow.control");
