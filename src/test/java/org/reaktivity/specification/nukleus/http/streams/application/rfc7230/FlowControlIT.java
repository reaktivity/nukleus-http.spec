 ...
 * under the License.
 */
package org.reaktivity.specification.nukleus.http.streams.application.rfc7230;
...
public class FlowControlIT
{
    private final K3poRule k3po = new K3poRule()
        .addScriptRoot("app", "org/reaktivity/specification/nukleus/http/streams/application/rfc7230/flow.control");
