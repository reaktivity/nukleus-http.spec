 ...
 * under the License.
 */
package org.reaktivity.specification.nukleus.http2.streams.network.rfc7540;
...
public class AbortIT
{
    ...
    @Specification({
        ...
        "${net}/client.sent.read.abort.on.open.request.response/server",
    })
    ...
    @Specification({
        ...
        "${net}/server.sent.read.abort.on.open.request.response/server",
    })
