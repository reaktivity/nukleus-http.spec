@REM
@REM Copyright 2016-2019 The Reaktivity Project
@REM
...
mv message.routing/proxy.must.not.transform.the.payload.of.a.request.that.contains.a.no.transform.cache.control/request.rpt message.routing/proxy.must.not.transform.the.payload.of.a.request.that.contains.a.no.transform.emulatedCache.control/client.rpt
mv message.routing/proxy.must.not.transform.the.payload.of.a.request.that.contains.a.no.transform.cache.control/response.rpt message.routing/proxy.must.not.transform.the.payload.of.a.request.that.contains.a.no.transform.emulatedCache.control/server.rpt
mv message.routing/proxy.must.not.transform.the.payload.of.a.response.that.contains.a.no.transform.cache.control/request.rpt message.routing/proxy.must.not.transform.the.payload.of.a.response.that.contains.a.no.transform.emulatedCache.control/client.rpt
mv message.routing/proxy.must.not.transform.the.payload.of.a.response.that.contains.a.no.transform.cache.control/response.rpt message.routing/proxy.must.not.transform.the.payload.of.a.response.that.contains.a.no.transform.emulatedCache.control/server.rpt
